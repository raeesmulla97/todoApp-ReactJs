...
const TodoItems = ({text, id, isComplete, deleteTodo, toggle}) => {
  return (
    <div className='flex items-center my-3 gap-2 hover:bg-slate-100 py-2'>

        <div onClick={() => {toggle(id)}} className='flex flex-1 items-center cursor-pointer text-balance overflow-auto' >
